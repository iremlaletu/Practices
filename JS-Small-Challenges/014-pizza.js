...
function findTheWinner(obj){
    // initialize some new variable: 
        // to keep track of the current highest vote number
        let highestVotes = 0;
        // to keep track of the current winning item
        let winningItem = "";
    ...
    for(let food in obj){
          ...
          if(obj[food] > highestVotes){
              // yes: set the new value of highestVotes in the current value and
